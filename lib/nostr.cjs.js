...
// nym-client.ts
var import_sdk = require("@nymproject/sdk");
var NymClient = class {
  nym;
  isInitialized;
  constructor() {
  ...
  async init() {
    ...
    this.nym = await (0, import_sdk.createNymMixnetClient)();
    if (!this.nym) {
  ...
  waitForNymClientReady(delay = 1e3) {
...
var nymClient = new NymClient();
var nym_client_default = nymClient;
...
function relayInit(url, options = {}) {
  ...
  async function connectRelay() {
    ...
    connectionPromise = new Promise((resolve, reject) => {
      ...
      nym_client_default.waitForNymClientReady().then(() => {
        if (nym_client_default.nym === null)
          return;
        nym_client_default.nym.events.subscribeToRawMessageReceivedEvent((e) => {
  ...
  async function trySend(params) {
    ...
    if (nym_client_default.nym !== null) {
      nym_client_default.nym.client.rawSend({
        payload: new TextEncoder().encode(msg),
        recipient: "2gc9QidpXs4YGKmphinsDhWTHxdy2TZgWYWz2VenN5jL.dkwwJqS1zXa9BuPAFdniRN2HxFvAbTybAmrUHGAT5KV@2BuMSfMW3zpeAjKXyKLhmY4QW1DXurrtSPEJ6CjX3SEh",
        replySurbs: 100
      });
    }
    try {
...
function relayInit2(url, options = {}) {
  let { listTimeout = 3e3, getTimeout = 3e3, countTimeout = 3e3 } = options;
  var ws;
  var openSubs = {};
  var listeners = newListeners2();
  var subListeners = {};
  var pubListeners = {};
  var connectionPromise;
  async function connectRelay() {
